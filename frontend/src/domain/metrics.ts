...
export const METRIC_DEFINITIONS: MetricDefinition[] = [
  ...
  { id: "fanFavouriteDiscoveryPercentile", label: "Fan Rank", shortLabel: "Fan Rank", help: "Favourites-to-popularity engagement ranked across this AniList anime population.", filterable: true, anilistOnly: true },
  { id: "year", label: "Year", shortLabel: "Year", help: "Release year from the catalog.", filterable: true, anilistOnly: false },
  { id: "chapters", label: "Episodes", shortLabel: "Ep", help: "AniList episode count when available.", filterable: true, anilistOnly: false },
  { id: "releaseDate", label: "Release date", shortLabel: "Rel", help: "Start date from the AniList anime record.", filterable: false, anilistOnly: false },
  { id: "endDate", label: "End date", shortLabel: "End", help: "Completion/end date when available.", filterable: false, anilistOnly: false },
  { id: "mangabakaLatestRank", label: "Latest added", shortLabel: "Add", help: "Legacy catalogue sort, not used by the anime feeds.", filterable: false, anilistOnly: false },
